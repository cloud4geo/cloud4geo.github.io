  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              <a
                href="https://github.com/cloud4geo"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/company/cloud4geo"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="LinkedIn"
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href={getLocalizedPath('/#process', locale)} className="hover:text-primary-400 transition-colors">
                  {tNav('process')}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="https://lotespro.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary-400 transition-colors">
                  LotesPro
                </a>
              </li>
              <li>
                <a href="https://savepics.app" target="_blank" rel="noopener noreferrer" className="hover:text-primary-400 transition-colors">
                  SavePics
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col sm:flex-row items-center justify-between text-sm gap-4">
